...
from MolKit.molecule import Molecule, Atom, AtomSet, Bond
from MolKit.moleculeParser import MoleculeParser
from MolKit.protein import Helix, Strand, Turn
from MolKit.protein import Protein, Chain, Residue, ResidueSet, ProteinSet
...
class Mol2Parser(MoleculeParser):
    ...
    def parse_MOL2_Sets(self, setRecords):
        ...
        setRecords = [x.split() for x in self.allLines[setRecords[0]:setRecords[1]]]
        i = 0
